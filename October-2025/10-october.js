...
using the following rules:
    ...
    - To calculate the total fuel needed: start with the payload mass, calculate the fuel 
      needed for that, add that fuel to the total mass, and calculate again. 
...
(2 additional kg), which increases the total mass to 62 kg, 
which needs 12.4 kg to lift - 0.4 additional kg - which is less 1 additional kg, 
so we stop here. The total mass to lift is 62.4 kg, 50 of which is the initial payload 
and 12.4 of fuel.
...
function launchFuel(payload) {
  ...
  let fuel = 0
  let massToLift = payload + totalFuel
  let addFuel = 0
  
 do {
    fuel = massToLift / 5
    addFuel = fuel - totalFuel
    massToLift += addFuel
    totalFuel += addFuel
